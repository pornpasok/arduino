...
static const uint8_t HWID[5] = {0x01, 0x2f, 0xe3, 0xcc, 0x07};// LINE 011a123a0c = HOME // 012fe3cc07 = YMC2018
static const uint8_t ADC_PIN = A0;  // 電圧入力ピン
...
void loop() {
  ...
  char dm[] = "Tono_HQ"; //Device Message ที่ต้องการส่งต้องไม่เกิน 13 ตัวอักษร (ความยาวรวม 14 byte)
