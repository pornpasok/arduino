...
const char* host = "https://dashboard.sookyenfarm/esp-post-data.php";
...
// I2C for SHT21 sensor
TwoWire I2CSHT21 = TwoWire(1);
...
//  keepOnerror = Wire.endTransmission();
//  Serial.print("I2C KeepOn Code:");
//  Serial.println(keepOnerror);
...
void setup() {
  ...
  // SHT21
  //I2CSHT21.begin(I2C_SDA_2,I2C_SCL_2,400000);
...
//      client.connect(host,443);
      ...
      HttpClient http_no_auth = HttpClient(client_no_auth, server, 443);
      http_no_auth.connectionKeepAlive();  // Currently, this is needed for HTTPS
      ...
      http_no_auth.post(resource, contentType, httpRequestData);
      
     // read the status code and body of the response
      int statusCode = http_no_auth.responseStatusCode();
      String response = http_no_auth.responseBody();
